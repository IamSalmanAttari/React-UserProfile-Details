  ...
  return (
    <div className=" bg-gray-950 text-blue-300 flex flex-wrap gap-3 justify-center py-10">
      <div className="left w-[49%]">
        <img
          className=" w-[100%]"
          src={profileImage || "/assets/imgs/default.png"}
          // {profileImage ? <img src={profileImage}/> : <img src="./assets/imgs/default.png"/> }
          alt=""
        />
      </div>
      ...
      <div className="right w-[49%] mt-14 text-center">
        ...
        <button
          ...
          className="mt-6 bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-blue-600 transition duration-200"
        >
          Go Back Home
        </button>
      </div>
